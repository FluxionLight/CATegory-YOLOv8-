...
if __name__ == "__main__":
    # 默认使用仓库内置数据集: 仓库根目录/CatCategoryData/cat dataset(可按需修改)
    BASE_DIR = Path(__file__).resolve().parent.parent
    TRAIN_DIR = str(BASE_DIR / "CatCategoryData" / "cat dataset" / "train")
    TEST_DIR = str(BASE_DIR / "CatCategoryData" / "cat dataset" / "test")
